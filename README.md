...
| Web dashboard | 5-view Preact SPA: Now (burst regime badge), Plan (24h Gantt), History (preemption indicators), Models, Settings (12 tunable optimization parameters) |
...
tests/                         # 367 tests (pytest-xdist parallel)
```
